...
val releaseVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("1.4.1")
val releaseVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("1790000004").map(String::toInt)
