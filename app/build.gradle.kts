...
val releaseVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("1.5.0")
val releaseVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("1790000005").map(String::toInt)
